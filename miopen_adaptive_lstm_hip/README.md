...
| | H128 | H256 | H512 |
|------|------|------|------|
| **shape** | `5/128/4/24, b512` | `5/256/4/24, b512` | `5/512/4/24, b512` |
| 原生 PyTorch (fp16) | 8.21s | 11.77s | 22.73s |
| **当前最优** | **4.39s** | **7.16s** | **9.83s** |
...
| gemm_scan fp16 | 7.16s | — | 循环 GEMM 从 fp32→fp16 |
| gate_accum fp16 | — | **9.83s** | H512 专属，累加式 GEMM + fp16 |
